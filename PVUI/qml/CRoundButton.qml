...
T.RoundButton {
    ...
    Material.elevation: flat ? control.down
                               || control.hovered ? 2 : 0 : control.down ? 12 : 6
    ...
    background: Rectangle {
        ...
        color: !control.enabled ? control.Material.buttonDisabledColor : control.checked
    ...
    states: [
        State {
            ...
            PropertyChanges {
                target: _contentItem
                font.pointSize: control.font.pointSize - 6
            }
        },
        State {
            name: "pressed"
            ...
            PropertyChanges {
                target: _contentItem
                font.pointSize: control.font.pointSize - 10
            }
        }
    ]
}
